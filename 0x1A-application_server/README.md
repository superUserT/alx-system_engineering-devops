...
| --- | --- | --- | --- | --- |
| 2015-web-01 | `ubuntu` | `44.201.67.236` | running |

Actions Toggle Dropdown

 |
| 2015-web-02 | `ubuntu` | `44.192.38.36` | running |

Actions Toggle Dropdown

 |
| 2015-lb-01 | `ubuntu` | `3.237.46.189` | running |
...
[Done with the mandatory tasks? Unlock 2 advanced tasks now!](https://alx-intranet.hbtn.io/projects/311/unlock_optionals)
